...
var TransitionContext = React46.createContext(null);

// node_modules/@mui/material/node_modules/@mui/base/useTransition/useTransitionStateManager.js
function useTransitionStateManager() {
  const transitionContext = React47.useContext(TransitionContext);
...
function useTransitionTrigger(requestEnter) {
  const [state, dispatch] = React48.useReducer(transitionStateReducer, {
    elementExited: !requestEnter,
    inProgress: false
  });
  const hasTransition = React48.useRef(false);
  const handleEntering = React48.useCallback(() => {
    dispatch("entering");
  }, []);
  const handleEntered = React48.useCallback(() => {
    dispatch("entered");
  }, []);
  const handleExiting = React48.useCallback(() => {
    dispatch("exiting");
  }, []);
  const handleExited = React48.useCallback(() => {
    dispatch("exited");
  }, []);
  React48.useEffect(() => {
  ...
  const registerTransition = React48.useCallback(() => {
...
var PopupContext = React49.createContext(null);
...
var Popup = React50.forwardRef(function Popup2(props, forwardedRef) {
  ...
  const popupContextValue = React50.useMemo(() => ({
    placement: finalPlacement
  }), [finalPlacement]);
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-QCMNFKID.js.map
