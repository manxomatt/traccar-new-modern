...
var GlobalPrefixedRule = function() {
  function GlobalPrefixedRule2(key, style, options) {
    ...
    this.rule = options.jss.createRule(selector, style, _extends3({}, options, {
      parent: this
    }));
  }
...
function handleNestedGlobalContainerRule(rule, sheet) {
  ...
  for (var name in rules) {
    sheet.addRule(name, rules[name], _extends3({}, options, {
...
function handlePrefixedGlobalRule(rule, sheet) {
  ...
  for (var prop in style) {
    ...
    sheet.addRule(selector, style[prop], _extends3({}, options, {
      selector
    }));
    delete style[prop];
  }
...
function jssNested() {
  ...
  function getOptions(rule, container, prevOptions) {
    if (prevOptions)
      return _extends4({}, prevOptions, {
        index: prevOptions.index + 1
      });
    var nestingLevel = rule.options.nestingLevel;
    nestingLevel = nestingLevel === void 0 ? 1 : nestingLevel + 1;
    var options = _extends4({}, rule.options, {
      nestingLevel,
    ...
    for (var prop in style) {
      ...
      if (isNested) {
        ...
        if ("replaceRule" in container) {
          container.replaceRule(name, style[prop], _extends4({}, options, {
            selector
          }));
        } else {
          container.addRule(name, style[prop], _extends4({}, options, {
            selector
          }));
        }
...
jss/dist/jss.esm.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-ZHCFRMCM.js.map
