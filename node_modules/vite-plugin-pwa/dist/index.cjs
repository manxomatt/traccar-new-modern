...
function _generateBundle({ options: options2, viteConfig, useImportRegister }, bundle) {
  ...
  if ((options2.injectRegister === "script" || options2.injectRegister === "script-defer") && !(0, import_node_fs3.existsSync)((0, import_node_path4.resolve)(viteConfig.publicDir, FILE_SW_REGISTER))) {
